...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { curso_id: @homework.curso_id, descripcion: @homework.descripcion, entrega: @homework.entrega, titulo: @homework.titulo }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { curso_id: @homework.curso_id, descripcion: @homework.descripcion, entrega: @homework.entrega, titulo: @homework.titulo }
    assert_redirected_to homework_path(assigns(:homework))
  end
